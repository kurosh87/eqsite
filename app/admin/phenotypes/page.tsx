/* eslint-disable @next/next/no-img-element -- admin screens render arbitrary remote phenotype assets */
...
export default async function AdminPhenotypesPage() {
  ...
  // Admin check - middleware also protects this but double-check here
  if (!user.isAdmin) {
    redirect("/");
  }
