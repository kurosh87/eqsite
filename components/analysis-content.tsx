...
/* eslint-disable @next/next/no-img-element -- analysis pages stream user-uploaded imagery */
...
export function AnalysisContent({ user, analysis }: AnalysisContentProps) {
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-lg mt-1">
                  {new Date(analysis.createdAt).toLocaleDateString(language, {
                    month: "long",
                    day: "numeric",
                    year: "numeric",
                  })}
          ...
          <div className="grid lg:grid-cols-2 gap-8 animate-slide-up">
                ...
                <Card className="border-2 shadow-lg bg-gradient-to-br from-primary/5 to-background">
                  <CardHeader className="border-b bg-muted/30">
                    <div className="flex items-center justify-between">
                      <CardTitle className="text-xl">{t.dashboard.history.bestMatch.replace(":", "")}</CardTitle>
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-6">
                      ...
                      <div className="flex-1 text-center sm:text-left">
                        ...
                        <Badge className="text-lg px-4 py-2 bg-primary">
                          {Math.round(topMatch.similarity * 100)}% {t.analysis.match}
                        </Badge>
                      </div>
                    </div>
                  </CardContent>
            ...
            <div className="space-y-6">
              ...
              <Card className="border-2 shadow-lg">
                <CardHeader className="border-b bg-muted/30">
                  <CardTitle className="text-xl">{t.analysis.geneticHeritage}</CardTitle>
                </CardHeader>
              ...
              <Card className="border-2 shadow-lg">
                <CardHeader className="border-b bg-muted/30">
                  <div className="flex items-center justify-between">
                    <CardTitle className="text-xl">{t.analysis.topMatches}</CardTitle>
                    <Badge variant="outline" className="px-3 py-1">
                      {topMatches.length} {t.dashboard.history.matches}
                    </Badge>
                  </div>
                </CardHeader>
                <CardContent className="pt-6">
