...
/* eslint-disable @next/next/no-img-element -- uploader preview relies on in-memory blob URLs */
...
export function PhotoUploader() {
  ...
  const handleUploadAndAnalyze = async () => {
    ...
    try {
      ...
      const { analysisId, error, matches, aiReport, raw, llmProvider } = await analyzeResponse.json();
      setProgress(100);
